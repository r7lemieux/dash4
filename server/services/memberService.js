...
//    path: '/2/members?sig_id=8970895&order=name&group_urlname=DallasAngularJS&sig=7273be2514c75c224229d3e76754de14c550b96d&offset=0&format=json&page=200'
...
exports.setMembers = function (str) {
  srv.members = JSON.parse(dataText).results;
  //members = global.data;
  exports.setMembers(str);

  fs.writeFileSync(dataText, filename);
};
